...
public class NotifyService_Copy4MAR2013 extends IntentService {
	...
	public NotifyService_Copy4MAR2013() {
		super("Notifier");
					...
					if (readMsg.equals("0")) {
						...
						if (hours <= history) {
							...
							PendingIntent pendingIntent = PendingIntent
									.getActivity(NotifyService_Copy4MAR2013.this, 0,
											myIntent,
				...
				case CallLog.Calls.MISSED_TYPE:
					...
					if (isread.equals("0")) {
						...
						if (hours <= history) {
							...
							/*
							 * start trying to get contact name using phone
							 * number
							 */
							Uri uri;
							String[] projection;
							...
							uri = Uri.withAppendedPath(uri,
									Uri.encode(phNumber));
							Cursor nameCursor = this.getContentResolver()
							...
							if (contactName != null && !contactName.isEmpty()) {
								...
								if (phNumber.equalsIgnoreCase("-1")) {
									phoneNotificationTitle = "Unknown";
								} else {
